...
def addmm_act(activation, linear, mat1):
    ...
    # Off-CUDA (MPS/CPU): the fused bf16 _addmm_activation is a CUDA kernel and
    # is broken/unsupported on MPS (produces garbage indices). Fall back to a
    # plain linear + activation in fp32 — numerically equivalent.
    if not mat1.is_cuda:
        y = F.linear(mat1, mat2, self)
